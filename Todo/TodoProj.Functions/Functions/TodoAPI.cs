...
using TodoProj.Common.Models;
using TodoProj.Common.Responses;
using TodoProj.Functions.Entities;

namespace TodoProj.Functions.Functions
{
    public static class TodoAPI
    {
            ...
            ILogger log)
        {
            ...
            string message = "Retreieved all todos";
            log.LogInformation(message);
